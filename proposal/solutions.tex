...
\item Winter 2013 - Summer 2013. The first year will focus on stretching 
    ...
    \subitem Flesh out \uppercase{SnipR}, the learning algorithm for mapping-based transformations,  
	 the code retargeting algorithm, and code retargeting operators.  
