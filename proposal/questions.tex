...
\begin{itemize}
	...
	executing code retargeting commands will be developed. This language's goal is to extend \uppercase{SnipR}'s 
	available functionality. To evaluate simplicity, a user study and a survey will be performed. For 
